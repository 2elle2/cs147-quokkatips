      ...
      <ScrollView style={styles.scrollView}>
        <View style={styles.review}>
          <View style={styles.titleDate}>
            ...
            <Text
              style={{ fontSize: 16, color: "#888888", textAlign: "right" }}
            >
              {review.createdAt}
            </Text>
          </View>
          <View style={styles.user}>
            ...
            <View style={styles.userNameBio}>
              ...
              <Text style={{ fontSize: 16, color: "#888888", marginLeft: 10 }}>
                {review.user.gradeLevels[0]} {review.user.subjects[0]} teacher
              </Text>
            </View>
          </View>
          ...
          <RatingCategory
            ...
            value={review.ratingEngagement.toFixed(1)}
          />
          <RatingCategory
            category="Ease of use"
            value={review.ratingEase.toFixed(1)}
          />
